            ...
            tasks
              ...
              <div key={task._id} className="bg-gray-800 rounded-xl border border-gray-700 p-5 shadow-sm transition hover:border-gray-600">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="font-bold text-lg text-white">{task.title} <span className="text-xs font-normal text-gray-400 bg-gray-700 px-2 py-0.5 rounded ml-2">{task.operation}</span></h3>
